...
<form class="mb-4" method="post" action="/profile/confirm-update-username">
    <label for="usuario mb-2" class="form-label">Usuari Actual</label>
    ...
    <input id="new_username" type="text" class="form-control mb-2" name="new_username">
    <!--Mostrat d'errors-->
    <?php if(!empty($errors)): ?>
